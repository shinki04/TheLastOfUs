...
import {
  ERROR_MESSAGES,
  ErrorMessageKey,
} from "@repo/shared/types/login-error";
    ...
    <div className="flex flex-col min-h-screen w-full items-center justify-center bg-transparent py-4 px-4 sm:px-6">
      ...
      <div className="bg-mainred-blur w-full max-w-md mx-auto rounded-3xl overflow-hidden shadow-2xl flex flex-col items-center">
        <div className="w-full flex flex-col items-center px-6 py-8 sm:px-10 sm:py-12 gap-5 sm:gap-6">
          ...
          <div className="flex items-center w-full gap-2 my-2 sm:my-4">
            <div className="h-px flex-1 bg-white/30 rounded-full" />
            <p className="px-2 text-custom-white/80 text-center text-sm sm:text-base leading-snug font-light">
              Vui lòng sử dụng tài khoản Microsoft{" "}
              <br className="hidden sm:block" />
              chính thức do nhà trường cấp để đăng nhập.
            </p>
            <div className="h-px flex-1 bg-white/30 rounded-full" />
          </div>
