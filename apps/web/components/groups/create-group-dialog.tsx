    ...
    <Dialog>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Bắt đầu một cộng đồng cho mọi người kết nối và chia sẻ.
          </DialogDescription>
        </DialogHeader>
        ...
        >
            ...
            children={(field) => (
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  <span className="text-muted-foreground mr-1 text-sm w-20">
                    /groups/
                  </span>
                  <Input
                    id="slug"
          ...
          <div className="grid grid-cols-2 gap-4">
            <form.Field
              ...
              children={(field) => (
                <div className="space-y-2">
                  ...
                  <Select
                    value={field.state.value}
                    onValueChange={(val: Privacy_Group) =>
                      field.handleChange(val as Privacy_Group)
                    }
                  >
                    <SelectTrigger>
            ...
            <form.Field
              ...
              children={(field) => (
                <div className="space-y-2">
                  <Label>Chế độ kiểm duyệt tham gia</Label>
                  <Select
                    value={field.state.value}
                    onValueChange={(val: Membership_Mode) =>
          ...
          <DialogFooter>
            <form.Subscribe
              ...
              children={([canSubmit, isSubmitting]) => (
                ...
                >
                  {isSubmitting || isPending ? "Đang tạo..." : "Tạo nhóm"}
                </Button>
              )}
            />
          </DialogFooter>
